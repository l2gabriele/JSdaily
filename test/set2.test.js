const set2 = require('../setsOfThree/set2');
import chai from 'chai';
const expect = chai.expect;

describe('Set #2', function(){
  describe('Exercise 1: Get Number of Digits', function(){
    xit('This function takes in a number, and it must return how many digits that number has', function(){
      expect(set2.getDigits(23892392359)).to.eql(11);
    });
  });

  describe('Exercise 2: Zero String', function(){
    xit('This function should find all the spaces in a string and replace them with zeros',function(){
  ...
  describe('Exercise 3: Flatten Array', function(){
    xit('This function takes in a multidimensional array, and must return a flattened, one-dimensional array from it.', function(){
