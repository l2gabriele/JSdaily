...
describe('Set #6', () => {
  ...
  describe('Exercise 2: Return the a words', function(){
    ...
    xit('The array should have all of the letters the begin with a, upper or lowercase', () => {
  ...
  describe('Exercise 3: Calculate a number from binary', function(){
    xit('This function must return a number', () => {
      expect(set6.numberFromBinary('1011')).to.be.an("number");
    });

    xit('This function should properly calculate a value based on its binary representation', function(){
